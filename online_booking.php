...
<div class="container-fluidImg m-5">
    ...
    <div class="bottom-left">Online Booking</div>
</div>
            ...
            foreach ($data1 as $i => $da) {
                echo "
                         <tr>
                              ...
                              <td style='width: 20%'><a href='book_me.php?depart_date=$selected_Date,$da[2],$da[0],$da[1],$da[3],$v' class='btn btn-primary'>Book Seat</a> </td>
                       </tr>
                        ";
            }
            ?>
